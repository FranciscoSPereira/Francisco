...
class MySeq:
    ...
    def __init__(self, seq, tipo="dna"):
        self.seq = seq.upper()
        self.tipo = tipo
        self.alfabeto_RNA = "AGCT"
        self.alfabeto_DNA = "AUGC"
    ...
    def valida(self):
        ...
        for i in range(len(self.seq)):
            if self.seq[i] not in self.alfabeto_DNA:
                if self.seq[i] not in self.alfabeto_RNA:
                    return "Sequencia invalida"
            if self.seq[i] == "T":
                timina += 1
            if self.seq[i] == "U":
                uracilo += 1
        if uracilo and timina >=1:
            return "Sequencia não pode ter uracilo e timina simultaneamente"
        elif uracilo >= 1:
            return "RNA"
        elif timina >=1:
            return "DNA"
    ...
    def valida(self):
        ...
        res = True
        i = 0
        while i < len(self.seq) and res: #i menor que res?
